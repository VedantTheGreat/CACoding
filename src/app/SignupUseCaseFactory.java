...
public class SignupUseCaseFactory {
    ...
    public static SignupView create(ClearViewModel clearViewModel, ClearUserDataAccessInterface clearDataAccessObject,
    ...
    private static ClearController createUserClearUseCase(ClearViewModel clearViewModel, ClearUserDataAccessInterface clearDataAccessObject) throws IOException {
        ...
        ClearInputBoundary userClearInteractor = new ClearInteractor(
                clearDataAccessObject, clearOutputBoundary, userFactory);
